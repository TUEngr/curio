// Code lightly modified from osr-rover-code by dongjineee 
// (https://github.com/nasa-jpl/osr-rover-code/blob/master/ROS/osr_gazebo/src/osr_controller.cpp)
// 
...
public:
    ...
    void publishAngles()
    {
        ...
        servo.joint_names = {"front_right_corner_joint", "front_left_corner_joint", "back_right_corner_joint", "back_left_corner_joint"};
